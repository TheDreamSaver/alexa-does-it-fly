const OD = [
  {
    name: "Dog",
    fact: "The Basenji is the only breed of dog that can't bark, but they can yodel!",
  ...
  {
    name: "Aeroplane",
    fact: "The oxygen in an airplane’s emergency oxygen masks lasts for only about 15 minutes.",
  ...
  {
    name: "Bee",
    fact: "Honey bees fly at 15 miles per hour. Honey bees' wings stroke 11,400 times per minute, thus making their distinctive buzz.",
  ...
  {
    name: "Butterfly",
    fact: "Butterflies taste with their feet and their eyes are made of 6,000 lenses and can see ultraviolet light.",
  ...
  {
    name: "Cat",
    fact: "A cat's nose is ridged with a unique pattern, just like a human fingerprint.",
  ...
  {
    name: "Crow",
    fact: "When a crow dies, its neighbours may throw a funeral to try and learn about potential dangers to their own lives.",
  ...
  {
    name: "Cheetah",
    fact: "The cheetah can reach its top speed in just 3 seconds and is the only cat that cannot completely retract its claws.",
  ...
  {
    name: "Dove",
    fact: "Dove Mostly live happily in woodlands and tropical forests and the female dove birds mostly lay two eggs at a time.",
  ...
  {
    name: "Dolphin",
    fact: "Dolphins are carnivores. The Killer Whale, also known as Orca, is actually a type of dolphin.",
  ...
  {
    name: "Elephant",
    fact: "Elephants are the largest land mammals. Wild elephants live in families called herds and the leader of the herd is usually the oldest female – she is called the Matriarch.",
  ...
  {
    name: "Hang Glider",
    fact: "The record for the longest distance flown by a hang glider is 475 miles made by Dustin Martin in 2012.",
  ...
  {
    name: "Helicopter",
    fact: "Most helicopters have two rotors, one on the top and one on the tail and the fastest recorded speed of a helicopter is roughly 248 miles per hour.",
  ...
  {
    name: "Lion",
    fact: "A lion’s heels don’t touch the ground when it walks.",
  ...
  {
    name: "Llama",
    fact: "Llamas are members of the camelid, or camel, family and can grow as much as 6 feet tall.",
  ...
  {
    name: "Swan",
    fact: "A male swan is called a Cob, and a female swan is called a Pen.",
  ...
  {
    name: "Zebra",
    fact: "Every zebra has a unique pattern of black and white stripes. A zebra’s stripy coat is thought to disperse more than 70 per cent of incoming heat",
